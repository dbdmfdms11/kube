...
curl -s -LO https://dl.k8s.io/release/v1.27.0/bin/linux/amd64/kubectl 2>&1
...
curl -L https://github.com/projectcalico/calico/releases/latest/download/calicoctl-linux-amd64 -o calicoctl >/dev/null 2>&1
